...
class ValuesController extends GetxController {
  ...
  ValuesController({required this.developmentController});
  ...
  ValuesSelfReflectDetailsData? _dataSelfReflact;
  ...
  ValuesSelfReflectDetailsData? get dataSelfReflact => _dataSelfReflact;
  TextEditingController get textTextController => _textTextController;

  getSelfReflactData(bool isShowLoading, String userId) async {
    Map<String, String> map = {
      "user_id": userId,
      "style_id": AppConstants.valuesId,
    };
    try {
      ...
      var response = await developmentController.getReflectDetails(
          map, DevelopmentType.values1);

      _isErrorSelfReflact = false;
      _errorMsgSelfReflact = "";
      _dataSelfReflact = response;
      _textTextController.text = _dataSelfReflact!.title.toString();
    } catch (e) {
