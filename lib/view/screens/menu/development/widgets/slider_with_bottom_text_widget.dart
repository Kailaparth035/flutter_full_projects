...
class MinusSliderWithBottomText extends StatefulWidget {
  const MinusSliderWithBottomText({
    super.key,
    this.mainTitle,
    required this.title,
  ...
  @override
  State<MinusSliderWithBottomText> createState() =>
      _MinusSliderWithBottomTextState();
}

class _MinusSliderWithBottomTextState extends State<MinusSliderWithBottomText> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                // ...widget.list.map(
                //   (e) => SliderWidget(
                //     sliderColor: e['color'] as Color,
                //     isEnable: true,
                //     value: e['value'] == null
                //         ? 0
                //         : CommonController.getSliderValue(
                //             e['value'].toString()),
                //     returnValue: (val) {},
                //   ),
                // )
