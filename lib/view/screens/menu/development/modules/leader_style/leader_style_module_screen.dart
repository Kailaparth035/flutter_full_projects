...
import 'package:aspirevue/view/screens/menu/development/modules/leader_style/leader_style_aspirevue_training_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/leader_style/leader_style_assess_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/leader_style/leader_style_goal_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/leader_style/leader_style_reputation_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/leader_style/leader_style_self_reflection_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/traits/traits_elearning_widget.dart';
import 'package:flutter/material.dart';
import 'package:sizer/sizer.dart';

class LeaderStyleModuleScreen extends StatefulWidget {
  const LeaderStyleModuleScreen({
    super.key,
    this.tabName,
  ...
  @override
  State<LeaderStyleModuleScreen> createState() =>
      _LeaderStyleModuleScreenState();
}

class _LeaderStyleModuleScreenState extends State<LeaderStyleModuleScreen>
  ...
  Widget _getViewWidget(String title) {
    switch (title) {
      case AppConstants.selfReflection:
        return LeaderStyleSelfReflectionWidget(
          userId: widget.userId,
        );

      case AppConstants.reputation:
        return LeaderStyleReputaionWidget(
          userId: widget.userId,
        );
      case AppConstants.assess:
        return LeaderStyleAssessWidget(
          userId: widget.userId,
        );

      case AppConstants.eLearning:
        return TraitsElearningWidget(
          styleId: AppConstants.leaderStyleId,
          userId: widget.userId,
        );
      case AppConstants.aspireVueTargeting:
        return LeaderStyleAspireVueTrainingWidget(
          userId: widget.userId,
        );
      case AppConstants.goalAchievement:
        return LeaderStyleGoalWidget(
          userId: widget.userId,
        );
      default:
        return const Text("");
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppbarWithBackButton(
            appbarTitle: AppString.leaderStyle,
