...
import 'package:aspirevue/view/screens/menu/development/modules/values/values_aspirevue_targeting_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/values/values_assess_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/values/values_goal_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/values/values_reputation_widget.dart';
import 'package:aspirevue/view/screens/menu/development/modules/values/values_self_reflection_widget.dart';
import 'package:flutter/material.dart';
import 'package:sizer/sizer.dart';

class ValuesModuleScreen extends StatefulWidget {
  const ValuesModuleScreen(
      {super.key,
      this.tabName,
  ...
  @override
  State<ValuesModuleScreen> createState() => _ValuesModuleScreenState();
}

class _ValuesModuleScreenState extends State<ValuesModuleScreen>
  ...
  Widget _getViewWidget(String title) {
    switch (title) {
      case AppConstants.selfReflection:
        return ValuesSelfReflectionWidget(userId: widget.userId);

      case AppConstants.reputation:
        return ValuesReputaionWidget(
          userId: widget.userId,
        );

      case AppConstants.assess:
        return ValuesAssessWidget(userId: widget.userId);

      case AppConstants.eLearning:
        return TraitsElearningWidget(
          userId: widget.userId,
          styleId: AppConstants.valuesId,
        );
      case AppConstants.aspireVueTargeting:
        return ValuesAspireVueTargetingWidget(
          userId: widget.userId,
        );

      case AppConstants.goalAchievement:
        return ValuesGoalWidget(
          userId: widget.userId,
        );
