import 'package:aspirevue/wistia_player_latest/wistia_player_latest_value.dart';
import 'package:flutter/material.dart';
import 'wistia_player_options.dart';

class WistiaPlayerLatestController
    extends ValueNotifier<WistiaPlayerLatestValue> {
  ...
  WistiaPlayerLatestController({
    required this.videoId,
    this.options = const WistiaPlayerOptions(),
  }) : super(WistiaPlayerLatestValue());
  ...
  _callMethod(String methodString) {
    //  changed here
    return value.webViewController!.runJavaScriptReturningResult(methodString);
  }
  ...
  void callMethod(val) => _callMethod(val);
  ...
  void updateValue(WistiaPlayerLatestValue newValue) => value = newValue;
